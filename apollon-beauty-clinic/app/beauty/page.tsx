...
export default function Home() {
  ...
  const campaignImages = [
    { src: "/images/campaign/feed.jpeg", alt: "夏直前引き締めキャンペーン メイン" },
    { src: "/images/campaign/feed01.jpeg", alt: "HIFUによる脂肪燃焼の仕組み" },
    { src: "/images/campaign/feed02.jpeg", alt: "脂肪溶解注射とのコンビネーション" },
    { src: "/images/campaign/feed03.jpeg", alt: "脂肪溶解注射の詳細" },
    { src: "/images/campaign/feed04.jpeg", alt: "高効果モデルのご紹介" },
  ]
                    ...
                    {campaignImages.map((image, index) => (
                      <div key={index} className="flex-shrink-0">
                        <img
                          ...
                          alt={image.alt}
                          className="w-64 h-64 object-cover rounded-lg shadow-md cursor-pointer hover:shadow-lg transition-shadow duration-300"
        ...
        {selectedImage !== null && (
          ...
          >
            <div className="relative max-w-4xl max-h-full">
              <img
                src={campaignImages[selectedImage].src || "/placeholder.svg"}
                alt={campaignImages[selectedImage].alt}
              ...
              {/* 次の画像ボタン */}
              {selectedImage < campaignImages.length - 1 && (
                <button
                  onClick={(e) => {
                    e.stopPropagation()
                    setSelectedImage(selectedImage + 1)
