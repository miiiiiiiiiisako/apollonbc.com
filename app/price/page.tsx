      ...
      mainTitles: [
        {
          title: "シミ・色素沈着治療",
          treatments: [
            { name: "シミスポット１cm*１cm", price: 2200, vipPrice: 1650, description: "" },
            { name: "シミ取り放題", price: 39800, vipPrice: 33000, description: "パック付" },
            { name: "シミ取り放題＋トーニング", price: 44980, vipPrice: 39600, description: "パック付" },
            { name: "肝斑トーニング", price: 11000, vipPrice: 6600, description: "パック付" },
          ...
          recommendations: [
            ...
            },
            {
              ...
              items: [
                ...
                { name: "トラネキサム酸化粧水", price: 5000 },
                { name: "シスペラ", price: 34100 },
              ],
            },
            {
              type: "マッサージピーリングおすすめ",
        ...
        },
        {
          title: "イボ治療",
          treatments: [
            { name: "〜2mm", price: 6600, vipPrice: 5500, description: "" },
            { name: "3~5mm", price: 8800, vipPrice: 6930, description: "" },
            { name: "5~9mm", price: 11000, vipPrice: 8965, description: "" },
            { name: "10mm~19mm", price: 16500, vipPrice: 13860, description: "" },
            { name: "20mm~", price: 19800, vipPrice: 16940, description: "" },
            { name: "1mm以下1(〜10個)", price: 16500, vipPrice: 13860, description: "" },
            { name: "1mm以下1(11〜20個)", price: 27500, vipPrice: 24970, description: "" },
            { name: "1mm以下1(21〜30個)", price: 35200, vipPrice: 33000, description: "" },
            { name: "1mm以下1(31〜40個)", price: 42900, vipPrice: 40920, description: "" },
            {
              name: "ダーモスコピー診断",
              price: 1100,
              vipPrice: 0,
        ...
        },
        {
          ...
          treatments: [
            ...
            { name: "Save Eyes　４回", price: 99000, vipPrice: 79200, description: "" },
            {
              ...
              price: 11000,
              vipPrice: 9900,
              description: "ハリツヤを出して顔���体の���ジワを改善",
            },
            {
              name: "マッサージピーリング（５回）",
              price: 46200,
        ...
        },
        {
          ...
          treatments: [
            ...
            { name: "ボライト（頬内側・額）", price: 55000, vipPrice: 38500, description: "" },
            { name: "ボライト（追加）", price: 55000, vipPrice: 38500, description: "肌状態をみながらご相談" },
            { name: "赤み取りレーザー", price: 11000, vipPrice: 9900, description: "毛細血管の拡張を抑えます" },
          ],
          recommendations: [
            {
              type: "赤みおすすめ治療",
              items: [
                { name: "赤み取りレーザー", price: 11000 },
                { name: "ボライト（頬のみ）", price: 110000 },
              ],
            },
            {
