...
const treatments = [
  ...
  },
  {
    ...
    content: (
      <>
        <h3 className="text-xl font-semibold mb-3">GOURI（液体糸リフト）</h3>
        <p className="mb-4">
          GOURI（ゴウリ）は、ポリカプロラクトン（PCL）という成分を用いた、世界初の液状PCL製剤です。
          「入れるフィラー」ではなく、肌の内部に3Dの足場をつくり、自分のコラーゲンを増やして肌そのものを立て直すコラーゲンブースター治療です。
        </p>

        <h4 className="text-lg font-medium mb-2">治療効果</h4>
        <p className="mb-3">
          お顔全体や首、手の甲など、広い範囲に自然なハリ・弾力・ツヤを出したい方に向いています。
          液状のPCLが皮膚内に均一に広がり、線維芽細胞を刺激してコラーゲン・エラスチンの産生を促すことで、以下のような加齢による複数のサインを「入れた感」なくまとめて改善していきます：
        </p>
        <ul className="list-disc list-inside mb-4">
          <li className="mb-1">フェイスラインのゆるみ</li>
          <li className="mb-1">ほうれい線・マリオネットライン</li>
          <li className="mb-1">目まわり・口まわりの小じわ</li>
          <li className="mb-1">首の縦じわ・横じわ</li>
          <li className="mb-1">手の甲のボリュームロス</li>
        </ul>

        <h4 className="text-lg font-medium mb-2">治療の流れ</h4>
        <ol className="list-decimal list-inside mb-4">
          <li className="mb-1">
            カウンセリング：洗顔後、医師が肌の状態・たるみの方向・骨格などを確認し、適したcc数と注入ポイントを決めます。
          </li>
          <li className="mb-1">
            施術準備：治療部位を消毒し、必要に応じて表面麻酔や冷却を行います。
          </li>
          <li className="mb-1">
            注入：顔の場合は片側数ポイントなど、限られた数のポイントにGOURIを注入します。そこから自然に広がるため、従来のスキンブースターのように細かく多数の注射を行う必要がなく、注入回数が少ない＝ダメージも少ないのが特徴です。
          </li>
          <li className="mb-1">
            施術時間：施術自体はおおよそ30分前後で終了し、お仕事や家事の合間にも受けやすい治療です。
          </li>
        </ol>

        <h4 className="text-lg font-medium mb-2">ダウンタイムと注意点</h4>
        <ul className="list-disc list-inside mb-3">
          <li className="mb-1">施術直後に、注入部位の赤み・ふくらみ・針穴が一時的に出ることがありますが、多くは数日以内に目立たなくなります。</li>
          <li className="mb-1">体質により内出血が出る場合がありますが、メイクで隠せる程度のことがほとんどです。</li>
        </ul>
        <p className="mb-3 font-medium">施術後の目安</p>
        <ul className="list-disc list-inside mb-4">
          <li className="mb-1">メイク：当日から可能（患部を強くこすらないようにしてください）</li>
          <li className="mb-1">シャワー・入浴：当日から可能（長時間の高温入浴は当日のみ控えめに）</li>
          <li className="mb-1">数日間は、サウナ・岩盤浴・温泉などの高温環境、激しい運動、大量の飲酒、強い顔マッサージやうつ伏せ寝はお控えください。</li>
        </ul>

        <h4 className="text-lg font-medium mb-2">治療回数と持続</h4>
        <p className="mb-3">
          Apollon Beauty Clinic では、GOURIは基本的に1回の施術でしっかり効果を出す治療としてご案内しています。
          個人差はありますが、1回の治療でリフトアップや首・手の質感改善が1〜2年程度持続することが期待されています。
        </p>
        <ul className="list-disc list-inside mb-4">
          <li className="mb-1">肌質やたるみが軽い方：まずは1回で十分なケースが多いです。</li>
          <li className="mb-1">強いたるみ・高度な肌やせがある方：状態を見ながら、数ヶ月〜1年の間に追加施術を1〜2回ご提案する場合があります。</li>
        </ul>
        <p>
          無理に回数を増やすのではなく、「1回でどこまで変わるか」を一緒に確認し、必要な方にだけ追加をご案内する方針です。
        </p>
      </>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="mb-4">
          カウンセリングでは、気になるシ��やくぼみの深さや状態を確認し、注入箇所や薬剤の量など最適な方法を提案します。施術前にはメイクを落とし、清潔な状態で治療を受けることが重要です。
        </p>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <h4 className="text-lg font-medium mb-2">治療効果</h4>
        <p className="mb-3">
          ショッピングリフトは、顔や首の皮膚引き締め改善をしながら美肌効果も���時に得られる一石二鳥の治療法です。この治療の主要な作用メカニズムは、医療用の吸収糸が真皮層に存在する線維芽細胞を刺激することで、コラーゲン産生を促進する点にあります。これにより、肌全体にハリや弾力が生まれ、若々しくみずみずしい肌へと導かれます。
        </p>
        <p className="mb-3">
  ...
  },
  {
    ...
    content: (
      <>
        <h3 className="text-xl font-semibold mb-3">糸リフト治療</h3>
        <p className="mb-4">
          糸リフトは、溶ける糸（当院では安全上の観点からPDOのみ使用しています）を皮下に挿入し、たるみを物理的に引き上げながら、糸の周囲でコラーゲン産生を促すことで、リフトアップと肌質改善を同時に目指す治療です。
          メスを使わずにフェイスラインのもたつき、ほうれい線、マリオネットライン、口角の下がりなどを改善したい方に向いています。
        </p>

        <h4 className="text-lg font-medium mb-2">治療効果</h4>
        <p className="mb-3">糸が「支え」と「牽引力」の両方を担うことで、以下のような効果が期待できます：</p>
        <ul className="list-disc list-inside mb-4">
          <li className="mb-1">フェイスラインの引き上げ</li>
          <li className="mb-1">ほうれい線・マリオネットラインの軽減</li>
          <li className="mb-1">頬のボリュームの位置調整（上方向へ）</li>
          <li className="mb-1">口角のリフトアップ</li>
          <li className="mb-1">首のたるみ・輪郭のもたつき</li>
        </ul>
        <p className="mb-4">
          当院では、目的や優先順位に応じて、ダウンタイムとコスパを重視した Dr.K Threads（ベーシック手技）、より強いリフト力と持続力を重視した ミントリフト（ベーシック／アドバンス手技）、肌質改善と土台作りを重視した ショッピングリフト（スレッドリフト）を組み合わせ、「引き上げ」と「支え」と「肌質改善」をバランスよく設計します。
        </p>

        <h4 className="text-lg font-medium mb-2">メニューの違い</h4>

        <h5 className="text-base font-medium mb-2">Dr.K Threads（ベーシック手技）</h5>
        <p className="mb-3">
          Dr.K Threads は、ダウンタイムや痛みをできるだけ抑えつつ、しっかりたるみを支えることを重視したベーシックな糸リフトです。
          必要なポイントに糸を通すことで、フェイスラインやほうれい線周りを自然にキュッと引き上げることを目指します。
        </p>
        <ul className="list-disc list-inside mb-4">
          <li className="mb-1">術後の痛みや腫れを最小限にしたい</li>
          <li className="mb-1">コストパフォーマンスを重視しつつ、まずは糸リフトを試したい</li>
        </ul>

        <h5 className="text-base font-medium mb-2">ミントリフト（ベーシック／アドバンス手技）</h5>
        <p className="mb-3">
          ミントリフトは、引き上げ力の強いコグ付きPDO糸を用いた、より本格的なリフトアップ治療です。
          とくにアドバンス手技では、皮下のリガメントやたるみの方向を細かく計算しながら糸を配置することで、より立体的で持続力の高いリフトアップ効果を目指します。
        </p>
        <ul className="list-disc list-inside mb-3">
          <li className="mb-1">効果をしっかり感じたい</li>
          <li className="mb-1">たるみが中等度〜強めで、フェイスラインや中顔面の変化をきちんと出したい</li>
        </ul>
        <p className="mb-4">
          その分、術後の痛みやツッパリ感が約1週間ほど続くことがあり、施術時間もDr.Kよりやや長くなりますが、痛みは基本的に鎮痛薬で対応できる範囲内です。
        </p>

        <h5 className="text-base font-medium mb-2">ショッピングリフト（スレッドリフト）</h5>
        <p className="mb-3">
          ショッピングリフトは、髪の毛より細い複数本のPDO糸を浅い層に入れていく、肌質改善と「支え作り」に特化した糸治療です。
          直接の強い引き上げというよりも、糸の本数を増やすことでコラーゲンを増やし、ちりめんじわ、毛穴の開き、うるおい不足によるハリのなさを底上げしつつ、将来のたるみを支える土台をつくるイメージです。
        </p>
        <p className="mb-4">
          ショッピングリフトは、Dr.KやミントリフトTと併用することで、深い層：糸リフトでリフトアップ、浅い層：ショッピングリフトでハリと支えを補強という構造になり、効果と持続の両方を高める組み合わせ治療になります。
        </p>

        <h5 className="text-base font-medium mb-2">鼻の糸リフト（Dr.K／ミント）</h5>
        <p className="mb-3">
          お鼻にも糸リフトを行うことができます。鼻筋を少し高くしたり、鼻先をきゅっと引き上げたい方に向いた治療です。
          1本ずつ糸を入れるたびに、正面・横顔のバランスを鏡で一緒に確認しながら、本数を最終決定します。
          「やりすぎたくない」「自然な範囲で変えたい」という方でも安心して受けていただけます。
          鼻のデザインや骨格に合わせて、Dr.KかミントリフトのどちらTが適しているかを医師がご提案します。
        </p>

        <h4 className="text-lg font-medium mb-2">治療の流れ（共通）</h4>
        <ol className="list-decimal list-inside mb-4">
          <li className="mb-1">
            カウンセリング：洗顔後、医師がたるみの程度・骨格・皮膚の厚み・左右差などを確認し、糸の種類・本数・位置を決定します。
          </li>
          <li className="mb-1">
            デザイン・準備：仕上がりイメージを共有しながらリフト方向のラインをデザインし、消毒と局所麻酔（または表面麻酔＋局所麻酔）を行います。
          </li>
          <li className="mb-1">
            糸の挿入：デザインに沿ってカニューレや針を用いて糸を挿入し、皮膚を持ち上げながらテンションを調整します。鼻の場合は、1本ずつ入れるごとに角度とボリュームを確認しながら、最もバランスの良いポイントで本数を確定します。
          </li>
          <li className="mb-1">
            終了・冷却：最後に左右差や不自然な凹凸がないかを確認し、必要に応じて軽く冷却して終了です。
          </li>
        </ol>

        <h4 className="text-lg font-medium mb-2">ダウンタイムと痛み</h4>
        <ul className="list-disc list-inside mb-3">
          <li className="mb-1">施術直後は、引き上げによるツッパリ感や圧迫感、口を大きく開けにくい感じが数日〜1週間程度続くことがあります。</li>
          <li className="mb-1">針穴の赤み・軽い腫れ・内出血が出る場合がありますが、多くはメイクで隠せる程度です。</li>
          <li className="mb-1">ミントリフト・アドバンス手技は、Dr.Kよりも引き上げ力が強いぶん、痛みや違和感が出やすいですが、鎮痛薬でコントロールできる範囲が一般的です。</li>
        </ul>
        <p className="mb-3 font-medium">施術後の生活の目安</p>
        <ul className="list-disc list-inside mb-4">
          <li className="mb-1">メイク：テープ保護のもと当日から可能（部位や本数により医師が個別に指示します）</li>
          <li className="mb-1">シャワー：当日から可、入浴は翌日以降に</li>
          <li className="mb-1">数日間は、サウナ・激しい運動・顔の強いマッサージ・大きなあくびや硬いものを強く噛む動作は控えてください。</li>
        </ul>

        <h4 className="text-lg font-medium mb-2">回数と持続の目安</h4>
        <p className="mb-3">
          糸の種類や本数、生活習慣にもよりますが、効果のピークは施術直後〜数ヶ月、持続の目安はおおよそ1年程度（個人差があります）です。
          多くの方は1回の施術でしっかり変化を感じていただけます。
        </p>
        <p>
          たるみが強い方や、さらにリフト力を高めたい方には、状態を見ながら半年〜1年以降の追加治療や、ショッピングリフト・GOURIなど他のコラーゲンブースターとの併用をご提案する場合があります。
        </p>
      </>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="mb-4">
          臨床研究では、治療開始から12週間後に毛髪密度と太さの顕著な改善が報告されていま��。エクソソームが毛周期の成長期部分の誘導と維持を促進し、脱毛を減少させ毛包周辺の炎症を軽減させる効果があることが示されています。
        </p>
